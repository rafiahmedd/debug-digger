<?php
namespace DebugDigger\App\Includes;
use Exception;
/**
 * All credit goes to WP-CLI for this class. I just copied it from their repo.
...
class ConfigTransformer {
	...
	public function add( $type, $name, $value, array $options = array() ) {
		...
		$defaults = array(
			...
			'anchor'    => "/** Sets up WordPress vars and included files. */", // Config placement anchor string.
